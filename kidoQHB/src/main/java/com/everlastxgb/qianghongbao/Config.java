...
public class Config {
    ...
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.everlastxgb.qianghongbao.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.everlastxgb.qianghongbao.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.everlastxgb.qianghongbao.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.everlastxgb.qianghongbao.NOTIFY_LISTENER_CONNECT";

    public static final String PREFERENCE_NAME = "config";
    public static final String KEY_ENABLE_WECHAT = "KEY_ENABLE_WECHAT";
    public static final String KEY_ENABLE_DINGTALK = "KEY_ENABLE_DINGTALK";
    ...
    public boolean isEnableDingtalk() {
        return preferences.getBoolean(KEY_ENABLE_DINGTALK, true) && UmengConfig.isEnableDingtalk(mContext);
    }
