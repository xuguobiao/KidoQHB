...
import com.everlastxgb.qianghongbao.job.WechatAccessbilityJob;
import com.everlastxgb.qianghongbao.util.BitmapUtils;
...
public class MainActivity extends BaseSettingsActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_open_service:
                openAccessibilityServiceSettings();
                QHBApplication.eventStatistics(this, "menu_service");
                return true;
            case R.id.action_open_notify:
            ...
            case R.id.action_feedback:
                ...
                QHBApplication.eventStatistics(this, "menu_feedback");
                break;
            case R.id.action_about:
//                startActivity(new Intent(this, AboutMeActivity.class));
                CommonUtils.openWeb(this, getString(R.string.about_url));
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent wxIntent = getPackageManager().getLaunchIntentForPackage(
                        WechatAccessbilityJob.PACKAGENAME);
                if (wxIntent != null) {
                    try {
    ...
    private void showDonateDialog() {
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                File output = new File(android.os.Environment.getExternalStorageDirectory(), "kido_wechatpay_qr.jpg");
                if (!output.exists()) {
     ...
     * 显示“使用前须知”对话框
     */
    private void showBeforeUseDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getString(R.string.beforeuse_title))
                .setMessage(getString(R.string.beforeuse_note))
                .setPositiveButton(getString(R.string.dialog_btn_iknown), null)
                .create().show();
    }
    ...
    public static class MainFragment extends BaseSettingsFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //钉钉红包开关
            Preference dingtalkPref = findPreference(Config.KEY_ENABLE_DINGTALK);
            dingtalkPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ((Boolean) newValue && !QiangHongBaoService.isRunning()) {
                        ((MainActivity) getActivity()).showOpenAccessibilityServiceDialog();
            ...
            preference = findPreference("KEY_BEFORE_USE");
            if (preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        ((MainActivity) getActivity()).showBeforeUseDialog();
                        QHBApplication.eventStatistics(getActivity(), "before_use");
                        return true;
                    }
                });
            }
