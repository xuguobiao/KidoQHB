...
public class WechatAccessbilityJob extends BaseAccessbilityJob {
    ...
    private static final String SEEHONGBAO_TEXT_KEY = "领取红包";
    ...
    private static final String PAGE_HOME = "com.tencent.mm.ui.LauncherUI"; // APP主页面
    private static final String PAGE_CHAT = ""; // 聊天页面
    private static final String PAGE_PICKREDPACKETS = "com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyReceiveUI"; // 拆红包页面
    private static final String PAGE_REDPACKETSDETAIL = "com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyDetailUI"; // 红包详情页
